...
export class UsersService {
  constructor(
    ...
    private activationRepository: Repository<Activate>,
  ...
  async store(req: CreateUsersDto) {
    ...
    const checkUser = await this.usersRepository.findOneBy({ email: getEmail });
  ...
  async activate(email: string, key: string) {
    ...
    const getUserObject = await this.usersRepository.findOneBy({
